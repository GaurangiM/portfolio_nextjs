    ...
    <div className="about-container">
      ...
      <div className="flex-about">
        <div className="about-text">
          <p>
            My name is Gaurangi Mane. I started off my career as a Software tester using manual testing and automation testing with Selenium. 
            After moving to Netherlands in 2018, I switched from testing to front end development through Codeisseur as I am really passionate 
            about front end world. I have 2.6 years of experience working with React + Redux and Flutter framework. I was responsible for development and maintainance of both web app and mobile app.
          </p>
